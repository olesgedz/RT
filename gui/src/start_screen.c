...
/*   Updated: 2019/09/22 14:56:15 by lminta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		start_screen(t_gui *gui)
{
	...
	gui->ed_w.framerect = (KW_Rect){10, 10, 300, 220};
	KW_RectCenterInParent(&gui->ed_w.winrect, &gui->ed_w.framerect);
	gui->ed_w.frame =
	KW_CreateFrame(gui->gui, NULL, &gui->ed_w.framerect);
