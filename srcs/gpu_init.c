...
void initScene(t_obj* cpu_spheres){
	...
	cpu_spheres[6].position = create_cfloat3 (-200.6f, 0.0f, 0.0f);
	...
	cpu_spheres[8].position = create_cfloat3 (0.0f, -200.4f, 0.0f);
