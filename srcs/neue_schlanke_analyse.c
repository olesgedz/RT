...
/*   Updated: 2019/12/08 19:25:44 by srobert-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	{
// 		obj->basis[0] = parse_vec3(parse->x_basis, 0);
...
// 	{
// 		obj->basis[1] = parse_vec3(parse->y_basis, 0);
...
// 	{
// 		obj->basis[2] = parse_vec3(parse->z_basis, 0);
...
// 	if (parse.composed_pos != NULL)
// 	{
// 		composed_pos_f = parse_vec3(parse.composed_pos);
...
// 	if (parse.composed_v != NULL)
// 	{
// 		composed_v_f = parse_vec3(parse.composed_v);
...
// void check_global_tex(cJSON *scene, t_game *game)
// {
...
// 	{
// 		game->global_tex_id = compare_in_texture_dict(game, global_texture->valuestring);
// 		if (game->global_tex_id == game->textures_num + 1)
// 		{
// 			game->global_tex_id--;
// 			ft_texture_push(game, &(game->texture_list), global_texture->valuestring);
// 		}
// 	}
// 	else
...
// t_filter check_filter(cJSON *scene, t_json parse)
// {
// 	t_filter filter;
...
// 	cameras = cJSON_GetObjectItemCaseSensitive(parse.json, "cameras");
...
// t_json prepare_scene(char *argv, t_game *game)
// {
//     FILE *fp;
// 	char buffer[462144];
//     t_json json;
...
// 	check_scene(json.json, game);

// 	json.objects = cJSON_GetObjectItemCaseSensitive(json.json, "objects");
// 	cJSON_ArrayForEach(json.object, json.objects)
// 	{
// 		check_object(json.object, game, NULL, NULL, id);
// 		id++;
// 	}
// 	id = -1;
// 	game->textures = (t_txture*)malloc(sizeof(t_txture) * game->textures_num);
// 	while(++id < game->textures_num)
// 		get_texture(game->texture_list[id], &(game->textures[id]), "./textures/");
